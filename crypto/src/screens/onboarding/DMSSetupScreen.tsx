              ...
              <>
                ...
                <Text style={styles.periodExplainer}>
                  {verifyMode === 'all'
                    ...
                    : `เลือก "คนใดคนหนึ่ง" (OR) — แค่คนใดคนหนึ่งในผู้รับกุญแจสำรองที่ตั้งไว้ยืนยันก็เปิดห้องได้ทันที สะดวกกว่า แต่บุคคลที่คุณไว้ใจคนใดคนหนึ่งก็สามารถกู้คืนคนเดียวได้เช่นกัน โดยไม่ต้องรอคนอื่น`}
                </Text>
              </>
            )}
