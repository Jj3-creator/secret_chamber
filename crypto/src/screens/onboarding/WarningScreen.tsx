...
const ACKNOWLEDGEMENTS = [
  ...
  'ฉันเข้าใจว่าผู้สร้างแอปนี้ไม่มีสำเนาข้อมูลของฉันเก็บไว้ที่ไหนเลย มีแค่ฉันคนเดียวที่เข้าถึงได้ ' +
    'และถ้าเกิดปัญหาใดๆ ทีมงานช่วยกู้คืนให้ไม่ได้จริงๆ',
  'ฉันเข้าใจว่าถ้าฉันไม่เข้าใช้ห้องนี้เลยเกิน 1 ปี ระบบจะลบห้องและไฟล์ทั้งหมดทิ้งถาวร โดยอัตโนมัติ กู้คืนไม่ได้',
  'ฉันเป็นผู้ป้อนข้อมูลทั้งหมดในห้องนี้ด้วยตัวเอง และยินยอมให้แอปเข้ารหัสและจัดเก็บข้อมูลนั้นไว้ตามที่อธิบายไว้ ' +
    '(นโยบายความเป็นส่วนตัว/PDPA ฉบับเต็มยังไม่ได้ผ่านการตรวจจากทนายความ)',
];
